        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header text-right">
              <button type="button" class="btn btn-success btn-sm" onclick="window.open('pdf?id1={{$tglDari ?? ''}}&id2={{$tglKe ?? ''}}&id3={{$input_customer ?? ''}}&id4={{$input_invoice ?? ''}}','_blank')">Cetak</button>
            </div>
            <div class="card-body">
