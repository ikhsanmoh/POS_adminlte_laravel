    ...
    <div class="row mx-auto" style="width:800px">
      <div class="col-md-12">
        <div class="card card-info">
          ...
          <!-- /.card-header -->
          <form class="form-horizontal" action="{{ route('customers.update.data') }}" method="post">
            {{ csrf_field() }}
            <div class="card-body">
              @foreach($dt as $d)
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required="required" name="nama_customer" value="{{ $d->nama_customer }}">
                  </div>
                </div>
                <div class="form-group row">
